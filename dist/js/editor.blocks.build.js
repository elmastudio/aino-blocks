...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ save)\n/* harmony export */ });\n/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! classnames */ \"./node_modules/classnames/index.js\");\n/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _icons__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./icons */ \"./src/blocks/icon/icons.js\");\n/**\n * External dependencies\n */\n\n\n/**\n * Internal dependencies\n */\n\n\n/**\n * WordPress dependencies\n */\nvar useBlockProps = wp.blockEditor.useBlockProps;\n\n\nfunction save(_ref) {\n\tvar attributes = _ref.attributes;\n\tvar iconType = attributes.iconType,\n\t    iconSize = attributes.iconSize,\n\t    alignment = attributes.alignment;\n\n\n\tvar iconClasses = classnames__WEBPACK_IMPORTED_MODULE_0___default()((classnames__WEBPACK_IMPORTED_MODULE_0___default()), iconSize, alignment, {});\n\n\tvar blockProps = useBlockProps.save({\n\t\tclassName: iconClasses\n\t});\n\n\treturn wp.element.createElement(\n\t\t'div',\n\t\tblockProps,\n\t\t_icons__WEBPACK_IMPORTED_MODULE_1__[\"default\"].quote\n\t);\n}\n\n//# sourceURL=webpack://ainoblocks/./src/blocks/icon/save.js?");
...
"use strict";
eval("module.exports = JSON.parse('{\"apiVersion\":2,\"name\":\"ainoblocks/icon\",\"title\":\"Icon\",\"category\":\"design\",\"description\":\"An icon block.\",\"keywords\":[\"ainoblocks\",\"icon\",\"svg\",\"image\"],\"attributes\":{\"iconType\":{\"type\":\"string\"},\"iconSize\":{\"type\":\"string\"},\"alignment\":{\"type\":\"string\"}},\"supports\":{\"color\":{\"text\":true,\"background\":false}}}');\n\n//# sourceURL=webpack://ainoblocks/./src/blocks/icon/block.json?");
