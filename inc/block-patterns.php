...
function abpatterns_register_block_patterns() {
	...
	foreach ( $block_pattern_categories as $name => $properties ) {
		...
		$block_patterns = array(
			...
			'heroes/default/6-col-gallery',
			'heroes/variant/6-col-gallery',
			'heroes/default/3-col-gallery',
			'heroes/variant/3-col-gallery',
			...
			'features/default/cards-3-col-2-rows-icon-text',
			'features/variant/cards-3-col-2-rows-icon-text',
			...
			'footers/default/4-col-newsletter',
			'footers/variant/4-col-newsletter',
