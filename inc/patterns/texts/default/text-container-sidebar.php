<?php
return array(
	'title'      => __( 'Text container + sidebar, default', 'abpatterns' ),
	'categories' => array( 'texts' ),
	'content'    => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|12"}}},"backgroundColor":"background-primary","layout":{"type":"constrained"}} -->
	<div class="wp-block-group alignfull has-background-primary-background-color has-background" style="padding-top:var(--wp--preset--spacing--12)"><!-- wp:ainoblocks/grid-container {"columnGap":"col-gap-m"} -->
	...
	<div class="wp-block-group"><!-- wp:heading {"textColor":"font-primary","className":"wp-block-heading","fontSize":"text-xxl"} -->
	<h2 class="wp-block-heading has-font-primary-color has-text-color has-text-xxl-font-size">Heading</h2>
	<!-- /wp:heading -->
	...
	<!-- wp:heading {"style":{"spacing":{"margin":{"top":"var:preset|spacing|9"}}},"textColor":"font-primary","className":"wp-block-heading","fontSize":"text-xxl"} -->
	<h2 class="wp-block-heading has-font-primary-color has-text-color has-text-xxl-font-size" style="margin-top:var(--wp--preset--spacing--9)">Heading</h2>
	<!-- /wp:heading -->
	...
	<!-- wp:paragraph {"style":{"spacing":{"padding":{"bottom":"var:preset|spacing|6"}}},"textColor":"font-secondary"} -->
	<p class="has-font-secondary-color has-text-color" style="padding-bottom:var(--wp--preset--spacing--6)">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Urna id integer orci, nunc pellentesque vitae dolor. Etiam mi volutpat, sed at ullamcorper arcu eget dui. Maecenas blandit erat tristique quis. Pellentesque pulvinar ullamcorper dui aliquam, viverra. Malesuada aliquam non congue porttitor dui sodales nec phasellus.</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:separator {"backgroundColor":"border-secondary"} -->
	<hr class="wp-block-separator has-text-color has-border-secondary-color has-alpha-channel-opacity has-border-secondary-background-color has-background"/>
	<!-- /wp:separator -->
	...
	<div class="wp-block-ainoblocks-grid-item col_start_d__9 col_end_d__12 col_start_t__7 col_end_t__13 col_start_m__1 col_end_m__13 align-self__stretch justify-self__stretch no-stacking mt_t__0 mt_m__6 align-self__start br-all__none pb__13"><!-- wp:heading {"textColor":"font-primary","className":"wp-block-heading","fontSize":"text-m","paddingBottom":5} -->
	<h2 class="wp-block-heading has-font-primary-color has-text-color has-text-m-font-size pb__5">Sidebar section</h2>
	<!-- /wp:heading -->
	
	<!-- wp:paragraph {"textColor":"font-secondary","fontSize":"text-xs"} -->
	<p class="has-font-secondary-color has-text-color has-text-xs-font-size">Omnis itaque iste. Quo aut beatae. Delectus voluptas maxime nam quia amet qui debitis ea qui. Incidunt iusto quam possimus pariatur corporis perspiciatis facilis voluptatem.</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:heading {"textColor":"font-primary","className":"wp-block-heading","fontSize":"text-m","paddingTop":10,"paddingBottom":5} -->
	<h2 class="wp-block-heading has-font-primary-color has-text-color has-text-m-font-size pt__10 pb__5">Sidebar section</h2>
	<!-- /wp:heading -->
	
	<!-- wp:group {"style":{"spacing":{"blockGap":"0.5rem"}},"layout":{"type":"flex","flexWrap":"wrap"}} -->
	<div class="wp-block-group"><!-- wp:ainoblocks/badge {"content":"Outdoors","size":"size__xs","backgroundColor":"neutral-tertiary","style":{"border":{"radius":"100px"}},"textColor":"font-primary"} -->
	<div class="wp-block-ainoblocks-badge size__xs has-font-primary-color has-neutral-tertiary-background-color has-text-color has-background" style="border-radius:100px"><span>Outdoors</span></div>
	<!-- /wp:ainoblocks/badge -->
	
	<!-- wp:ainoblocks/badge {"content":"Industrial","size":"size__xs","backgroundColor":"neutral-tertiary","style":{"border":{"radius":"100px"}},"textColor":"font-primary"} -->
	<div class="wp-block-ainoblocks-badge size__xs has-font-primary-color has-neutral-tertiary-background-color has-text-color has-background" style="border-radius:100px"><span>Industrial</span></div>
	<!-- /wp:ainoblocks/badge -->
	
	<!-- wp:ainoblocks/badge {"content":"Cities","size":"size__xs","backgroundColor":"neutral-tertiary","style":{"border":{"radius":"100px"}},"textColor":"font-primary"} -->
	<div class="wp-block-ainoblocks-badge size__xs has-font-primary-color has-neutral-tertiary-background-color has-text-color has-background" style="border-radius:100px"><span>Cities</span></div>
	<!-- /wp:ainoblocks/badge -->
	
	<!-- wp:ainoblocks/badge {"content":"Lifestyle","size":"size__xs","backgroundColor":"neutral-tertiary","style":{"border":{"radius":"100px"}},"textColor":"font-primary"} -->
	<div class="wp-block-ainoblocks-badge size__xs has-font-primary-color has-neutral-tertiary-background-color has-text-color has-background" style="border-radius:100px"><span>Lifestyle</span></div>
	<!-- /wp:ainoblocks/badge -->
	
	<!-- wp:ainoblocks/badge {"content":"Camping","size":"size__xs","backgroundColor":"neutral-tertiary","style":{"border":{"radius":"100px"}},"textColor":"font-primary"} -->
	<div class="wp-block-ainoblocks-badge size__xs has-font-primary-color has-neutral-tertiary-background-color has-text-color has-background" style="border-radius:100px"><span>Camping</span></div>
	<!-- /wp:ainoblocks/badge -->
	
	<!-- wp:ainoblocks/badge {"content":"Computers","size":"size__xs","backgroundColor":"neutral-tertiary","style":{"border":{"radius":"100px"}},"textColor":"font-primary"} -->
	<div class="wp-block-ainoblocks-badge size__xs has-font-primary-color has-neutral-tertiary-background-color has-text-color has-background" style="border-radius:100px"><span>Computers</span></div>
	<!-- /wp:ainoblocks/badge -->
	
	<!-- wp:ainoblocks/badge {"content":"Grocery","size":"size__xs","backgroundColor":"neutral-tertiary","style":{"border":{"radius":"100px"}},"textColor":"font-primary"} -->
	<div class="wp-block-ainoblocks-badge size__xs has-font-primary-color has-neutral-tertiary-background-color has-text-color has-background" style="border-radius:100px"><span>Grocery</span></div>
	<!-- /wp:ainoblocks/badge -->
	...
	<!-- wp:ainoblocks/badge {"content":"Shoes","size":"size__xs","backgroundColor":"neutral-tertiary","style":{"border":{"radius":"100px"}},"textColor":"font-primary"} -->
	<div class="wp-block-ainoblocks-badge size__xs has-font-primary-color has-neutral-tertiary-background-color has-text-color has-background" style="border-radius:100px"><span>Shoes</span></div>
	<!-- /wp:ainoblocks/badge -->
	
	<!-- wp:ainoblocks/badge {"content":"Tools","size":"size__xs","backgroundColor":"neutral-tertiary","style":{"border":{"radius":"100px"}},"textColor":"font-primary"} -->
	<div class="wp-block-ainoblocks-badge size__xs has-font-primary-color has-neutral-tertiary-background-color has-text-color has-background" style="border-radius:100px"><span>Tools</span></div>
